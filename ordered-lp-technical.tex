...
The reader should feel free to skip this \lcnamecref{sec:ordered-lp:technical} (especially if he is familiar with ordered logic), since the technical details are not critical to an understanding of the rest of this proposal.
