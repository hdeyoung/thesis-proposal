...
This is the idea of \vocab{concurrent equality} from the \acs{CLF}~\autocite{Watkins+:CMU02} framework for linear logical specification framework, later adapted by \textcite{Simmons:CMU12} for ordered logical specifications.
...
Therefore, we implicitly assume that all traces are weakly transition-fair.
