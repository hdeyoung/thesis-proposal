...
\begin{frame}[fragile]
  ...
  \column{0.5\textwidth}
    ...
    \begin{itemize}
    \item Functional programming% (ML, Haskell)
    \item Types --- preservation and progress properties
    % \item $\lambda x{:}A.\, M_x : A \mathbin{\to} B$
    \end{itemize}
  ...
  \column{0.55\textwidth}
    ...
    \begin{itemize}
    \item Committed choice bottom-up logic programming%\\(Prolog, Datalog)
    \item Only minimal types --- can get stuck
    % \item $c : p \mathbin{\leftarrow} A$
    \end{itemize}
